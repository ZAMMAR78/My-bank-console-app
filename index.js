...
// create customers 
const customers = [
    new Customer("ALi", "Raza", "Male", 35, 3166783676, accounts[0]),
    new Customer("Farzana", "zaman", "Female", 40, 3336783676, accounts[1]),
    new Customer("Mumtaz", "Begum", "Female", 30, 3416783676, accounts[2])
];
